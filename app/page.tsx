...
const plotData = [
  ...
  },
  {
    ...
    images: ["/images/nature-green-valley-phase5.jpg", "/images/ganeshpur-plots.jpg"],
    rating: 4.7,
    reviews: 89,
    available: 8,
    isPopular: false,
  ...
  },
  {
    ...
    images: ["/images/friends-colony-phase1.jpg", "/images/dehradun-outskirts-plots.jpg"],
    rating: 4.6,
    reviews: 67,
    available: 5,
    isPopular: false,
                            ...
                            <div className="flex-1">
                              ...
                              <Button
                                ...
                                onClick={() =>
                                  window.open(
                                    contact.href,
                                    contact.href.startsWith("tel:") || contact.href.startsWith("mailto:") ? "_self" : "_blank"
                                  )
                                }
                                className="text-blue-600 border-blue-500 hover:bg-blue-50"
                              >
                  ...
                  <div className="p-0">
                    ...
                    <div className="space-y-3">
                      <Button
                        ...
                        onClick={() =>
                          window.open(
                            "https://wa.me/917870231314?text=Hi, I would like to schedule a site visit for plots in Uttarakhand",
                            "_blank"
                          )
                        }
                      >
