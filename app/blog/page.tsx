...
// --- DATA: Merged Unsplash Images + Full HTML Content ---
const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: `
      ...
      <p>To streamline your search, consider using verified real estate platforms or consultants like <strong>Narayan GrowthWave</strong>. We feature verified plot listings, highlight essential details, and facilitate transparent verification. Buying through a trusted partner minimizes the risk of fraud.</p>
...
// Added all the missing categories from the data array
const categories = [
  "All", 
  "Market Trends", 
  "Location Guide", 
...
export default function BlogPage() {
  ...
  const filteredPosts = blogPosts.filter((post) => {
    ...
    // Clean and simple category filter logic
