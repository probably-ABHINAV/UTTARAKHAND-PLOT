...
<<<<<<< Updated upstream
      ...
      <div className="fixed left-6 bottom-6 z-50">
        <Button
          size="lg"
          className="rounded-full w-14 h-14 bg-blue-600 hover:bg-blue-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 animate-bounce"
          asChild
        >
          <Link href="/chatbot">
      ...
      <div className="fixed right-6 bottom-6 z-50">
        ...
        >
          <a 
            href="https://wa.me/917870231314?text=Hello! I'm interested in your Uttarakhand properties." 
            target="_blank" 
