...
// --- DATA ---
// (Included directly as per your setup)
const blogPosts: BlogPost[] = [
  ...
  // You can paste the rest of the array here...
];
...
export default function BlogPostPage() {
  ...
  // If the post is not found, display a 404-style state
  if (!post) {
    return (
  ...
  // Generate a dynamic, free placeholder image based on the post ID
  // Using a standard img tag avoids next.config.js remote pattern errors for external domains
  const freeFeaturedImage = `https://picsum.photos/seed/${post.id + 100}/1200/600`;
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      ...
      <main className="flex-grow container mx-auto px-4 py-12 md:px-6">
        ...
        <div className="max-w-4xl mx-auto mb-8">
          <Button asChild variant="ghost" className="text-gray-600 hover:text-orange-600 pl-0">
        ...
        <article className="max-w-4xl mx-auto bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <div className="p-8 md:p-12 pb-8">
            <Badge variant="secondary" className="bg-orange-100 text-orange-700 hover:bg-orange-200 mb-6 px-3 py-1">
              {post.category}
            </Badge>
            ...
            <div className="flex flex-wrap items-center text-sm text-gray-500 gap-y-3 gap-x-6">
          ...
          <div className="p-8 md:p-12">
            <div 
              className="prose prose-lg prose-orange max-w-none 
                         ...
                         [&>h2]:text-3xl [&>h2]:font-bold [&>h2]:text-gray-900 [&>h2]:mt-10 [&>h2]:mb-4
