...
export default function LocationsPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-[#F7931E] 50">
      <SiteHeader />
              ...
              >
                <div className="relative overflow-hidden h-80">
                  ...
                  <div className="absolute bottom-6 left-6 text-white">
                    <Badge className="bg-[#F7931E]/90 mb-3 text-sm px-3 py-1">{location.plotsAvailable}</Badge>
                  ...
                  <div className="absolute top-6 right-6 flex flex-col gap-2">
                    <Badge className="bg-white/95 text-[#F7931E] font-bold text-sm px-3 py-1">
                      <TrendingUp className="mr-1 h-3 w-3" />
                      {location.growth}
                    </Badge>
                    <Badge className="bg-white/95 text-[#FF6B35] font-bold text-sm px-3 py-1">
                      {location.priceRange}
                    </Badge>
                  </div>
                </div>
                ...
                <CardContent className="p-8 space-y-6">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center p-4 bg-blue-50 rounded-lg">
                      <div className="text-xl font-bold text-[#FF6B35]">{location.connectivity}</div>
                      <div className="text-sm text-gray-600">Connectivity</div>
                    </div>
                    <div className="text-center p-4 bg-green-50 rounded-lg">
                      <div className="text-xl font-bold text-[#F7931E]">{location.growth}</div>
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    <div className="text-center p-4 bg-purple-50 rounded-lg">
                      <h5 className="font-semibold text-[#F7931E] mb-2">Demographics</h5>
                    ...
                    <div className="text-center p-4 bg-teal-50 rounded-lg">
                      <h5 className="font-semibold text-[#F7931E] mb-2">Rental Yield</h5>
                      <div className="text-xs text-gray-600 space-y-1">
                  ...
                  <div className="pt-4 space-y-3">
                    <Button 
                      className="w-full bg-gradient-to-r from-[#FF6B35] to-[#F7931E] hover:from-blue-600 hover:to-green-600 text-lg py-3"
                    ...
                    <Button 
                      variant="outline"
                      className="w-full border-2 border-[#FF6B35] text-[#FF6B35] hover:bg-blue-50 py-3"
